...
--
-- Host: localhost
-- Generation Time: May 22, 2019 at 12:44 PM
...
CREATE TABLE `student` (
  ...
  `w2_n2` varchar(100) NOT NULL,
  `w2_n3` varchar(100) NOT NULL,
  `w2_n4` varchar(100) NOT NULL,
  `w2_n5` varchar(100) NOT NULL,
...
INSERT INTO `student` (`id`, `username`, `password`, `name`, `class`, `w1_n1`, `w1_n2`, `w1_n3`, `w1_n4`, `w1_n5`, `w2_n1`, `w2_n2`, `w2_n3`, `w2_n4`, `w2_n5`, `status`, `server`, `ip`, `ban`, `quiz_t1_n1`, `quiz_t1_n2`, `quiz_t1_n3`) VALUES
(1, '47471', 'b772565da6893753972235a882ae699e', 'ธนวัฒน์ กุลาตี', 2, '0.4', '0.4', '0.4', '0.4', '0.4', '0.4', '0.4', '0.4', '0.4', '0.4', 'user', 1, '192.168.1.119', 1, '3', '3', '0'),
(2, '47472', '2d01216e288ff2a1a0fd90c4a4b6bd0c', 'ทดสอบ', 2, '0.4', '', '0.4', '', '', '', '', '', '', '', 'user', 1, '', 1, '0', '3', '4'),
(3, '47473', '34435249b8b3b8e48ea4460075fe0d4a', 'ทดสอบ2', 2, '', '', '', '', '', '', '', '', '0.4', '', 'user', 1, '', 1, '', '', '');
